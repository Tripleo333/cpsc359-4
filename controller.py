'''
class: controller.
Purpose: The controller class is the parent class of both accelerometer
         and joystick. It defines abstract methods that are used to control
         the game. These methods must be defined by accelerometer and joystick.
'''
